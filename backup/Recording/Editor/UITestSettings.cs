...
namespace ODDGames.UIAutomation.Editor
{
    ...
    public static class UITestSettings
    {
        ...
        {
            get => PlayerPrefs.GetString(LastRecordingFolderPref, "");
            set => PlayerPrefs.SetString(LastRecordingFolderPref, value);
        }
        ...
        {
            get => PlayerPrefs.GetString(PendingTestDataSourceKey, "");
            set
            {
                if (string.IsNullOrEmpty(value))
                    PlayerPrefs.DeleteKey(PendingTestDataSourceKey);
                else
                    PlayerPrefs.SetString(PendingTestDataSourceKey, value);
            }
        }

        public static string PendingRecordingFolder
        {
            get => PlayerPrefs.GetString(PendingRecordingFolderKey, "");
            set
            {
                if (string.IsNullOrEmpty(value))
                    PlayerPrefs.DeleteKey(PendingRecordingFolderKey);
                else
                    PlayerPrefs.SetString(PendingRecordingFolderKey, value);
            }
        }
