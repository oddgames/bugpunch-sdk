...
namespace ODDGames.Bugpunch.DeviceConnect
{
    ...
    public class PlayerPrefsService
    {
        ...
        public string GetAll()
        {
            ...
            {
                Debug.LogError($"[Bugpunch] PlayerPrefs enumerate failed: {ex.Message}");
        ...
        List<PrefEntry> EnumerateKeys()
        {
            ...
            Debug.LogWarning("[Bugpunch] PlayerPrefs enumeration not supported on this platform");
#endif
            return entries;
        }
        ...
        void EnumerateMacOS(List<PrefEntry> entries)
        {
            ...
            if (!File.Exists(plistPath))
            {
                ...
                {
                    Debug.LogWarning("[Bugpunch] Failed to enumerate PlayerPrefs on macOS");
                }
                return;
            }
            ...
            {
                Debug.LogWarning($"[Bugpunch] Failed to read plist: {ex.Message}");
            }
        }
