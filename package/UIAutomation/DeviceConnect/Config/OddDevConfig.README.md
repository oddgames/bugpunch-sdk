...
Configuration ScriptableObject for the OddDev device connection SDK.

## Setup

1. In Unity: **Assets > Create > ODD Games > OddDev Config**
2. Place the created asset in a `Resources/` folder (e.g., `Assets/Resources/OddDevConfig.asset`)
...
| Field | Description |
|-------|-------------|
| **Server URL** | Your OddDev server URL. Use `ws://` for local dev, `wss://` for production. Example: `wss://yourserver.b4a.run` |
...
1. Open your OddDev dashboard
2. Go to a project's settings page
3. Click **Create API Key**
4. Copy the key into the **API Key** field in your OddDevConfig asset
