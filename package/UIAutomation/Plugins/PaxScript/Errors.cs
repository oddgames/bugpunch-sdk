...
namespace PaxScript.Net
{
	#region Errors Class
	/// <summary>
	/// C# compiler errors. See MSDN for more information.
	/// </summary>
	public class Errors
	{
		...
		public const string CS0067 = "CS0067. The event '{0}' is never used."; // warning level 3
		...
		public const string CS0070 = "CS0070. The event 'event' can only appear on the left hand side of += or -= (except when used from within the type 'type')."; // not implemented
		public const string CS0071 = "CS0071. An explicit interface implementation of an event must use property syntax"; // not implemented
		...
		public const string CS0078 = "CS0077. The 'l' suffix is easily confused with the digit '1' -- use 'L' for clarity."; // warning (level 4)
		...
		public const string CS0108 = "CS0108. The keyword new is required on '{0}' because it hides inherited member '{1}'"; // warning (level 2)
		public const string CS0109 = "CS0109. The member '{0}' does not hide an inherited member. The new keyword is not required."; // warning (level 4)
		...
		public const string CS0114 = "CS0114. '{0}' hides inherited member '{1}'. To make the current method override that implementation, add the override keyword. Otherwise add the new keyword."; // warning (level 2)
		...
		public const string CS0136 = "CS0136. " +
			"A local variable named '{0}' cannot be declared in this scope because it " +
			"would give a different meaning to '{0}', which is already used in a '{1}' scope " +
		...
		public const string CS0162 = "CS0162. Unreachable code detected."; // warning (level 2)
		...
		public const string CS0168 = "CS0168. The variable '{0}' is declared but never used."; // warning (level 3)
		public const string CS0169 = "CS0169. The private field '{0}' is never used."; // warning (level 3)
		...
		public const string CS0183 = "CS0183. The given expression is always of the provided ('{0}') type."; // warning (level 1)
		...
		public const string CS0219 = "CS0219. The variable '{0}' is assigned but its value is never used."; // warning (level 3)
		...
		public const string CS0252 = "CS0252. Possible unintended reference comparison; to get a value comparison, cast the left hand side to type '{0}'"; // warning (level 2)
		public const string CS0253 = "CS0253. Possible unintended reference comparison; to get a value comparison, cast the right hand side to type '{0}'"; // warning (level 2)
		...
		public const string CS0602 = "CS0602. The feature '{0}' is deprecated. Please use '{1}' instead."; // warning (level 2)
		...
		public const string CS0612 = "CS0612. '{0}' is obsolete."; // warning (level 1)
		...
		public const string CS0626 = "CS0626. Method, operator, or accessor '{0}' is marked external and has no attributes on it. Consider adding a DllImport attribute to specify the external implementation."; // warning (level 1)
		public const string CS0628 = "CS0628. '{0}' : new protected member declared in sealed class."; // warning (level 4)
		...
		public const string CS0642 = "CS0642. Possible mistaken null statement."; // warning (level 3)
		...
		public const string CS0649 = "CS0649. Field '{0}' is never assigned to, and will always have its default value '{1}'."; // warning (level 4)
		...
		public const string CS0652 = "CS0652. Comparison to integral constant is useless; the constant is outside the range of type '{0}'."; // warning (level 2)
		...
		public const string CS0660 = "CS0660. '{0}' defines operator == or operator != but does not override Object.Equals(object o)."; // warning (level 3)
		public const string CS0661 = "CS0661. '{0}' defines operator == or operator != but does not override Object.GetHashCode()."; // warning (level 3)
		...
		public const string CS0665 = "CS0665. Assignment in conditional expression is always constant; did you mean to use == instead of = ?"; // warning (level 3)
		...
		public const string CS0672 = "CS0672. Member '{0}' overrides obsolete member '{1}'. Add the Obsolete attribute to '{0}'."; // warning (level 1)
		...
		public const string CS0684 = "CS0684. '{0}' interface marked with 'CoClassAttribute' not marked with 'ComImportAttribute'."; // warning (level 1)
		...
		public const string CS1030 = "CS1030. #warning: '{0}'."; // warning (level 1)
		...
		public const string CS1036 = "CS1036. ( or . expected."; // xml
		public const string CS1037 = "CS1037. Overloadable operator expected."; //xml
		...
		public const string CS1522 = "CS1522. Empty switch block."; // warning (level 1)
		...
		public const string CS1571 = "CS1571. XML comment on '{0}' has a duplicate param tag for '{1}'."; // warning (level 2)
		public const string CS1572 = "CS1572. XML comment on '{0}' has a param tag for '{1}', but there is no parameter by that name."; // warning (level 2)
		public const string CS1573 = "CS1573. Parameter '{0}' has no matching param tag in XML comment (but other parameters do)."; // warning (level 4)
		public const string CS1574 = "CS1574. XML comment on '{0}' has cref attribute '{0}' that could not be found."; // warning (level 1)
		...
		public const string CS1580 = "CS1580. Invalid type for parameter '{0}' in XML comment cref attribute."; // warning (level 1)
		...
		public const string CS1584 = "CS1584. XML comment on '{0}' has syntactically incorrect cref attribute '{1}'."; // warning (level 1)
		...
		public const string CS1587 = "CS1587. XML comment is not placed on a valid language element."; // warning (level 2)
		public const string CS1588 = "CS1588. Cannot determine common language runtime directory -- '{0}'.";
		public const string CS1589 = "CS1589. Unable to include XML fragment '{0}' of file '{1}' -- '{2}'."; // warning (level 1)
		public const string CS1590 = "CS1590. Invalid XML include element -- Missing file attribute."; // warning (level 1)
		public const string CS1591 = "CS1591. Missing XML comment for publicly visible type or member '{0}'."; // warning (level 4)
		...
		public const string CS1595 = "CS1595. '{0}' is defined in multiple places; using definition from '{1}'."; // warning (level 1)
		public const string CS1596 = "CS1596. XML documentation not updated during this incremental rebuild; use /incremental- to update XML documentation."; // warning (level 1)
		public const string CS1597 = "CS1597. Semicolon after method or accessor block is not valid.";
		public const string CS1598 = "CS1598. XML parser could be not be loaded for the following reason: '{0}'. The XML documentation file '{1}' will not be generated."; // warning (level 1)
		...
		public const string CS1607 = "CS1607. Assembly generation -- '{0}'."; // warning (level 1)
		...
		public const string CS2023 = "CS2023. Ignoring /noconfig option because it was specified in a response file."; // warning (level 1)
		...
		public const string CS3012 = "CS3012. You must specify the CLSCompliant attribute on the assembly."; // warning (level 1)
		...
		public const string PAX0001 = "PAX0001. Module not found.";
		public const string PAX0002 = "PAX0002. Unknown language '{0}'.";
		public const string PAX0003 = "PAX0003. Cannot load compiled module '{0}' from '{1}'";
		public const string PAX0004 = "PAX0004. Incorrect scripter state. Expected '{0}'";
		public const string PAX0005 = "PAX0005. Error in Invoke. Method '{0}' not found.";
		public const string PAX0006 = "PAX0006. Use of forbidden namespace '{0}'.";
		public const string PAX0007 = "PAX0007. Use of forbidden type '{0}'.";
		public const string PAX0008 = "PAX0008. Current version of paxScript does not support '{0}'.";
		public const string PAX0009 = "PAX0009. Error in RegisterInstance method. You have tried to register object which is not initialized.";
		public const string PAX0010 = "PAX0010. Error in RegisterInstance method. You have tried to register object which is already registered.";
		...
		#region PaxScriptException Class
		/// <summary>
		/// paxScript exception class.
		/// </summary>
		public class PaxScriptException: Exception
		{
			/// <summary>
			/// Constructor.
			/// </summary>
			public PaxScriptException(string message): base(message)
			{
			}
		}
		#endregion PaxScriptException Class
		...
		{
			throw new PaxScriptException(s);
		}
		...
		{
			throw new PaxScriptException(String.Format(s, p));
		}
	}
	#endregion Errors Class
}
