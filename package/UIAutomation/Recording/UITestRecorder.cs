...
namespace ODDGames.UIAutomation
{
    public class UITestRecorder : MonoBehaviour
    {
        ...
        public void StopRecording()
        {
            ...
            UnityEditor.EditorPrefs.SetString("ODDGames.UIAutomation.LastRecordingFolder", LastRecordingFolder);
#endif
...
#if UNITY_EDITOR
        [UnityEditor.MenuItem("Window/UI Automation/Create Test Recorder")]
