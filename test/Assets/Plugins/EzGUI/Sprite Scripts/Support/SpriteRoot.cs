...
*/
		...
		public virtual void SetCamera (Camera c)
		{
				...
				if ((screenSize.x == 0 || c != renderCamera) && c.pixelHeight > 100)
						...
						worldUnitsPerScreenPixel = Vector3.Distance (c.ScreenToWorldPoint (new Vector3 (0, 1, dist)), c.ScreenToWorldPoint (new Vector3 (0, 0, dist))) * scale;
...
// 			return true;
		...
		{
			get { return new Vector2 (width / worldUnitsPerScreenPixel * scale, height / worldUnitsPerScreenPixel * scale); }
		...
		// than 10 seconds:
#if (UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_2018 ) && UNITY_EDITOR
		void Update ()
		{
				DoMirror ();
		}
