...
public class UIButton3D : ControlBase, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
	/// <summary>
	...
	public override void OnInput(ref POINTER_INFO ptr)
	{
		...
		switch(ptr.evt)
		{
			...
			case POINTER_INFO.INPUT_EVENT.TAP:
				...
				if (ptr.type != POINTER_INFO.POINTER_TYPE.TOUCHPAD && this != null && ptr.hitInfo.collider == GetComponent<Collider>())
					SetControlState(CONTROL_STATE.OVER);
				else
					SetControlState(CONTROL_STATE.NORMAL);
				break;
	...
	public override void OnDisable()
	{
		...
		// is closing:
		if (EZAnimator.Exists() && !isDestroyed)
		{
    ...
    {
        OnInput(new POINTER_INFO()
        {
            evt = POINTER_INFO.INPUT_EVENT.TAP,
            targetObj = this,
            active = true,
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        OnInput(new POINTER_INFO()
        {
            evt = POINTER_INFO.INPUT_EVENT.PRESS,
            targetObj = this,
            active = true,
            activeTime = Time.time
        });
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        OnInput(new POINTER_INFO()
        {
            evt = POINTER_INFO.INPUT_EVENT.RELEASE,
            targetObj = this,
            active = false
        });
    }
