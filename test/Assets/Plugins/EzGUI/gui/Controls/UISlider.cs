...
public class UISlider : AutoSpriteControlBase
{
    ...
    public void AjustValue( float val )
    {
        m_value = m_value + val;
	...
	/// </summary>
	public Vector3 knobColliderSizeFactor = new Vector3(1f, 1f, 1f);
	...
	public override void OnInput (POINTER_INFO ptr)
	{
		...
		if (ptr.evt == POINTER_INFO.INPUT_EVENT.TAP)
		{
			...
			m_value = Mathf.Clamp01(knob.GetScrollPos(Camera.main.ScreenToWorldPoint(ptr.devicePos).x));
    ...
    public override void RemoveInputDelegate()
	{
		if (knob != null)
			knob.RemoveInputDelegate();

		base.RemoveInputDelegate();
	}
