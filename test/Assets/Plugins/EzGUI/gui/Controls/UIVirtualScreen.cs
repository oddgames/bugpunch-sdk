...
public class UIVirtualScreen : MonoBehaviour, IUIObject
{
	...
	[SerializeField]
	private bool useFirstPointerOnly = true;

	public bool UseFirstPointerOnly { get { return useFirstPointerOnly; } }
	...
	public void OnOver(POINTER_INFO ptr)
	{
	...
	protected void SetupControls()
	{
		...
		{
			controls[i].RemoveInputDelegate();
		...
		for (int i = 0; i < cs.Length; ++i)
		{
			obj = (IUIObject)cs[i];
			controls.Add(obj);
			obj.SetInputDelegate(InputProcessor);
