...
public class UIScrollKnob : UIButton
{
	...
	protected Vector3 colliderSizeFactor; // Factor by which our size will be multiplied to set the size of our collider.
	...
	public void SetColliderSizeFactor(Vector3 csf)
	{
	...
	/// </summary>
	/// <returns>A value in the range 0-1 indicating the scroll position.</returns>
	public float GetScrollPos(float x)
	{
		return (x - origPos.x) / maxScrollPos;
	}
	...
	public override void UpdateCollider()
	{
		...
		bc.size = new Vector3(bc.size.x * colliderSizeFactor.x, bc.size.y * colliderSizeFactor.y, bc.size.x * colliderSizeFactor.z);
